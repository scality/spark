...
files = "%s://%s/%s/spark-ARCORPHAN.csv" % (PROTOCOL, PATH, RING)
...
filenamearc = "%s://%s/%s/spark-ARCORPHAN-CORRUPTED.csv" % (PROTOCOL, PATH, RING)
...
filenamearc = "%s://%s/%s/spark-ARCORPHAN-CORRUPTED-BUT-OK.csv" % (PROTOCOL, PATH, RING)
